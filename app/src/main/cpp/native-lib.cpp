...
char* personalization = "myclient-sample-app";

auto android_logger = spdlog::android_logger_mt("android","myclient_ndk");

extern "C" JNIEXPORT jstring JNICALL
Java_ru_iu3_myclient_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
    std::string hello = "This is a click me! text";
...
Java_ru_iu3_myclient_MainActivity_initRng(
        JNIEnv *env,
        jclass MainActivity
        ) {
...
Java_ru_iu3_myclient_MainActivity_randomBytes(JNIEnv *env, jclass MainActivity, jint no) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_myclient_MainActivity_encrypt(JNIEnv *env, jclass MainActivity, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_myclient_MainActivity_decrypt(JNIEnv *env, jclass MainActivity, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
